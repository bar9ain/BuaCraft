...
public class ModelChrisCringle extends ModelHuman {
	private ModelRenderer helmet, helmet1, helmet2, helmet3, helmet4, bodyArmor, bodyArmor1, bodyArmor2, bodyArmor3,
			bodyArmor4, bodyArmor5, bodyArmor6;
	...
	public ModelChrisCringle() {
		...
		this.bipedHead.addBox(-4F, -8.0F, -6.0F, 8, 8, 8);
		...
		this.bipedRightArmwear = new ModelRenderer(this, 48, 32);
