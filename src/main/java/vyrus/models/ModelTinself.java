...
public class ModelTinself extends ModelHuman {
	...
	public ModelTinself() {
		...
		helmet2 = new ModelRenderer(this, 32, 3);
		helmet2.addBox(4F, -5.0F, -1F, 3, 1, 1, 0.1F);
		this.bipedHead.addChild(helmet2);

		helmet3 = new ModelRenderer(this, 30, 1);
		helmet3.addBox(4F, -4.0F, -1F, 2, 1, 1, 0.1F);
		...
		helmet5.addBox(-7F, -5.0F, -1F, 3, 1, 1, 0.1F);
		helmet5.mirror = true;
		this.bipedHead.addChild(helmet5);

		helmet6 = new ModelRenderer(this, 32, 0);
		helmet6.addBox(-4F, -11.0F, -4F, 8, 2, 8, 0.1F);
