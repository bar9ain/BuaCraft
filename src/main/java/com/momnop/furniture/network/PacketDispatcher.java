...
public class PacketDispatcher
{
  ...
  {
    registerMessage(MessageSofaData.Handler.class, MessageSofaData.class, Side.CLIENT);
    registerMessage(MessageChairData.Handler.class, MessageChairData.class, Side.CLIENT);
  }
